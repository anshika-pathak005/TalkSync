...
const ConnectionPickerRow = ({ person, isSelected, onToggle }) => (
    <motion.div
        whileTap={{ scale: 0.98 }}
        onClick={onToggle}
        className={`flex items-center gap-2 sm:gap-3 px-2.5 sm:px-3 py-2 sm:py-2.5 rounded-xl cursor-pointer
    ...
    >
        ...
        <div className={`w-4 h-4 sm:w-5 sm:h-5 rounded-md border-2 flex items-center justify-center shrink-0 transition-all
            ${isSelected
                ? 'bg-gradient-to-r from-peacock to-cerulean border-transparent'
                : 'border-nordic/50'
            }`}>
            {isSelected && <Check size={11} className="text-white sm:w-[13px] sm:h-[13px]" />}
        </div>
    </motion.div>
)
            ...
            <AnimatePresence>
                {isOpen && (
                    <>
                        ...
                        >
                            <div className="w-full max-w-lg bg-white rounded-xl sm:rounded-2xl shadow-2xl
                                ...
                                <div className="flex items-center justify-between gap-2 px-4 sm:px-6 py-3 sm:py-4
                                    ...
                                    <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs sm:text-sm text-saltwater font-normal truncate">
                                ...
                                <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 sm:py-5 space-y-4 sm:space-y-5">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl bg-swan/60 border border-nordic/30
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {/* Connections list */}
                                        <div className="max-h-48 sm:max-h-56 overflow-y-auto border border-nordic/20
                                            ...
                                            {connectionsLoading ? (
                                                ...
                                                <div className="flex items-center justify-center py-5 sm:py-6 text-xs sm:text-sm text-saltwater">
                                    ...
                                    {selectedUsers.length > 0 && (
                                        ...
                                        >
                                            <div className="flex items-center justify-between gap-2">
                                                <p className="text-xs sm:text-sm font-semibold text-viridian/80 flex items-center gap-2">
                                                    <UserCheck size={16} />
                                                    Members ({selectedUsers.length})
                                                </p>
                                                <span className="text-xs sm:text-sm text-saltwater whitespace-nowrap">
                                            ...
                                            <div className="flex flex-wrap gap-1.5 sm:gap-2 p-2.5 sm:p-3 bg-swan/60 rounded-xl
                                                border border-nordic/30 min-h-[48px] sm:min-h-[56px]">
                                                {selectedUsers.map((u) => (
                                                    <UserListforGroup
                                                        key={u._id}
                                                        user={u}
                                    ...
                                    <div className="flex items-start gap-2.5 sm:gap-3 p-3 sm:p-4 bg-cerulean/5 rounded-xl
                                        ...
                                        <Users size={16} className="text-cerulean mt-0.5 flex-shrink-0 sm:w-[18px] sm:h-[18px]" />
                                        <div>
                                            <p className="text-xs sm:text-sm font-semibold text-viridian/80">Quick tip</p>
                                ...
                                <div className="flex items-center justify-between gap-2 px-4 sm:px-6 py-3 sm:py-4
                                    ...
                                    <button
                                        onClick={handleClose}
                                        className="px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl text-sm sm:text-base font-semibold text-saltwater
